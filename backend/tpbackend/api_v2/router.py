...
from tpbackend.api_v2.games.routes import router as api_v2_games
from tpbackend.api_v2.platforms.routes import router as api_v2_platforms
...
from tpbackend.api_v2.activities.routes import router as activities_router
